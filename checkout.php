            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  ?>
                      <p> <a href="book_details.php?details=<?php echo $fetch_cart['book_id']; ?>"><?php echo $fetch_cart['name']; ?></a><span class="price">(<?php echo 'IQ ' . $fetch_cart['price'] . '/-' . ' x ' . $fetch_cart['quantity']; ?>)</span> </p>
                  <?php
                    }
                  } else {
                  ...
                  <hr>
                  <p>Grand total : <span class="price" style="color:black">IQ <b><?php echo $grand_total; ?>/-</b></span></p>
                </div>
              </div>
